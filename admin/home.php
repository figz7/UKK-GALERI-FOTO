...
<head>
	...
	<style>
		...
		body {
			...
			/* Posisi gambar agar di tengah */
			background-attachment: fixed;
			/* Agar background tetap saat scrolling */
		}
	</style>
</head>
...
<body>
	<nav class="navbar navbar-expand-lg bg-dark">
		<div class="container">
			<a class="navbar-brand text-white" href="index.php">Website Gallery Foto</a>
			...
			<div class="collapse navbar-collapse mt-2" id="navbarNavAltMarkup">
				<div class="navbar-nav me-auto">
					...
					<a href="album.php" class="nav-link text-white">Album</a>
					<a href="foto.php" class="nav-link text-white">Foto</a>
				</div>
												...
												<div class="m-2">
													<div class="overflow-auto">
														<div class="sticky-top">
															...
															<?php
															$fotoid = $data['fotoid'];
															$dataUser = mysqli_query($koneksi, "SELECT * FROM user WHERE userid='$userid'");
															$rowUser = mysqli_fetch_array($dataUser);
															?>
															<span
																class="badge bg-secondary"><?php echo $rowUser['namalengkap'] ?></span>
															<span
																class="badge bg-secondary"><?php echo $data['tanggalunggah'] ?></span>
															<?php
															$albumid = $data['albumid'];
															$dataAlbum = mysqli_query($koneksi, "SELECT * FROM album WHERE albumid='$albumid'");
															$rowAlbum = mysqli_fetch_array($dataAlbum);
															?>
															<span
																class="badge bg-primary"><?php echo $rowAlbum['namaalbum'] ?></span>
														</div>
														<hr>
														<p align="left">
